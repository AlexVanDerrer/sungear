    ...
    <div class="row">
        <div class="col-lg-3 mb-5">
            <div class="list-group" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-action active" id="list-home-list" data-toggle="list" href="#feedback-form" role="tab" aria-controls="home">Ремонт гидротрансформаторов</a>
                <a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#work-stage" role="tab" aria-controls="profile">Этапы работ</a>
        ...
        <div class="col-lg-9">
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="feedback-form" role="tabpanel" aria-labelledby="list-home-list">
                    ...
                    <div class="container-fluid shadow my-5 p-5" style="border: 1px solid f8f8f8; border-radius: 6px; background-color: #f0f0f0">
                            ...
                            <div class="col-5">
                                <form>
                                    <div class="form-group">
                                        <input type="text" class="form-control br-20" id="exampleFormControlInput1" placeholder="Имя">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control br-20" id="exampleFormControlInput1" placeholder="+7(___)___-__-__">
                                    </div>
                                    <div class="form-group">
                                        <select class="form-control br-20" id="exampleFormControlSelect1"  placeholder="Выберите модель АКПП">>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                        <option>4</option>
                        ...
                        <div class="row">
                            <div class="col-5"><button class="btn btn-danger shadow br-20 w-100" type="button">Не знаю свою модель</button></div>
                            <div class="col-7 d-flex justify-content-center"><button class="btn btn-danger shadow br-20 w-75" type="button">Заказать ремонт</button></div>
                        </div>
                    </div>
                </div>
